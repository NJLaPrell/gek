...
export class ResourceLoader {
  ...
  public getResource = (options: ResourceLoaderOptions): Promise<UserResource> => {
    ...
    if (!resource) throw `"${opts.name}" is not a recognized resource.`;
  ...
  public updateResourceItem = async (resourceName: string, uniqueIdentifier: string, idValue: string, resourceItem: any) =>
    this.store.updateResourceItem(resourceName, uniqueIdentifier, idValue, resourceItem);
